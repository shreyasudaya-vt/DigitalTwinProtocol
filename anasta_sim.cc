...
int main(int argc, char *argv[]) {
    ...
    uavMob->AddWaypoint(Waypoint(Seconds(0.0),   Vector(0.0,   0.0, 0.0))); // t=0:   start at BS
    uavMob->AddWaypoint(Waypoint(Seconds(100.0),  Vector(100.0, 0.0, 0.0))); // t=100: far end
    uavMob->AddWaypoint(Waypoint(Seconds(200.0),  Vector(0.0,   0.0, 0.0))); // t=200: return to BS
    uavMob->AddWaypoint(Waypoint(Seconds(300.0),  Vector(100.0, 0.0, 0.0))); // t=300: far end again
